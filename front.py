...
class LoginPage(QWidget):
    def __init__(self):
        ...
        self.forget_button = QPushButton("Asosiy oynaga qaytish")
...
class AdminPage(QMainWindow):
    ...
    def populate_admins_table(self):
        ...
        for row, val in enumerate(admins_data):
            ...
            info_button = QPushButton(QIcon("view.png"),"")
            ...
            self.admins_table.setItem(row, 1, QTableWidgetItem(email))
...
class UserPage(QMainWindow):
    ...
    def create_bottom_menu(self):
        ...
        for icon, method in icons:
            ...
            button.setIconSize(QSize(40, 40))  # Ikonalarni kattalashtirish
            button.clicked.connect(method)
    ...
    def show_special_offers_page(self):
        # Method to display special offers page
        pass

    def show_orders_page(self):
        # Method to display orders page
        pass
    ...
    def show_user_profile_page(self):
        # QMessageBox.warning(self, f"{name}\n{id_info}\nPhone number: {department}")
        pass
